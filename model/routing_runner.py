...
class DeterministicRunner(DynamicModel):
    ...
    def initial(self):
        self.reporting = Reporting(self.configuration, self.model, self.modelTime)
...
def main():
    ...
    if noSpinUps > 0:
        ...
        while spinUpRun < noSpinUps and has_converged == False:
            spinUpRun += 1
            currTimeStep.getStartEndTimeStepsForSpinUp(configuration.globalOptions['startTime'], spinUpRun, noSpinUps)
